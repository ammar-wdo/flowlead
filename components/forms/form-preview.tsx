                          ...
                          >
                            <FormControl>
                              <SelectTrigger className=" text-start p-4 !h-12">
                                <SelectValue className=" text-start" placeholder="Select an Option" />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
...
None
                              ...
                              {serviceElement.options.map((option) => (
                                ...
                                <div className="relative aspect-square w-8 rounded-full overflow-hidden">
                                   { option.image && <Image src={option.image} alt={option.name} className="object-cover" fill />}
                                </div>
                                    </div>
                              ...
                              >
                                <div className="flex flex-col gap-1 justify-between">
                                  ...
                                  <div className="flex items-center justify-between">
                                    ...
                                    {!!field.value?.id && !!serviceElement.options.find(el=>el.id === field.value.id)?.enableQuantity ? (
                                      <div className="flex border items-center h-8 bg-white text-black rounded-lg overflow-hidden">
                                        <button
                                          onClick={(e) => {
                                            e.stopPropagation();
                                ...
                                <div className="flex items-center gap-1">
                                  <div className="relative aspect-square rounded-lg overflow-hidden flex-1">
                                    {!!serviceElement.options.find(el=>el.id === field.value?.id)?.image && (
                                      <Image
                                        src={serviceElement.options.find(el=>el.id === field.value?.id)?.image || ''}
                                        alt={serviceElement.options.find(el=>el.id === field.value?.id)?.name || ''}
                                        fill
                                        className="object-cover"
                                      />
                                    )}
                                  ...
                                  <div className="flex items-center justify-between">
                                    ...
                                    (field.value || []).some(
                                      ...
                                      <div className="flex border items-center h-8 bg-white text-black rounded-lg overflow-hidden">
                                        ...
                                        <p className="px-3 py-1">
                                          {field.value[i]?.quantity || 0}
                                        </p>
                                        <button
                                          onClick={(e) => {
                                            e.stopPropagation();
                                            if (field.value[i]?.quantity === 1)
                                              return;
